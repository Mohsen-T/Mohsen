                        ...
                        <div class="col-md-12">
                            ...
                            <div class="item-entry">
                                ...
                                <div class="item-content">
                                    <div class="item-body">
                                        <div class="col-md-2 col-sm-2 clear-padding text-center">
                                            <img src="{{asset('assets/landing/images/airline/airline.jpg')}}" alt="cruise">
                                        </div>
                                        <div class="col-md-4 col-sm-4">
                            ...
                            <div class="item-entry">
                                ...
                                <div class="item-content">
                                    <div class="item-body">
                                        <div class="col-md-2 col-sm-2 clear-padding text-center">
                                            <img src="{{asset('assets/landing/images/offer2.jpg')}}" alt="cruise">
                                        </div>
                                        <div class="col-md-4 col-sm-4">
                                            <h4>Grand Lilly <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></h4>
                                            <p>Check In: 22 Aug </p>
                            ...
                            <div class="item-entry completed">
                                ...
                                <div class="item-content">
                                    <div class="item-body">
                                        <div class="col-md-2 col-sm-2 clear-padding text-center">
                                            <img src="{{asset('assets/landing/images/offer3.jpg')}}" alt="cruise">
                                        </div>
                                        <div class="col-md-4 col-sm-4">
                                            <h4>Wonderful Europe</h4>
                                            <p>Start: 22 Aug </p>
                            ...
                            <div class="col-md-6">
                                <div class="card-entry">
                                    ...
                                    <div class="card-type">
                                        ...
                                        <div class="pull-right">
                                            <img src="{{asset('assets/landing/images/card/card.jpg')}}" alt="cruise">
                                        </div>
                                    </div>
                                </div>
                            </div>
